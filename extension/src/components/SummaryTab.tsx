...
const LANGUAGES = [
  ...
  { value: 'Chinese (Traditional)', nativeLabel: '繁體中文' },
  { value: 'Bengali',              nativeLabel: 'বাংলা' },
  { value: 'Urdu',                 nativeLabel: 'اردو' },
  { value: 'Indonesian',           nativeLabel: 'Bahasa Indonesia' },
  { value: 'Vietnamese',           nativeLabel: 'Tiếng Việt' },
  { value: 'Thai',                 nativeLabel: 'ไทย' },
  { value: 'Telugu',               nativeLabel: 'తెలుగు' },
  { value: 'Marathi',              nativeLabel: 'मराठी' },
  { value: 'Tamil',                nativeLabel: 'தமிழ்' },
  { value: 'Gujarati',             nativeLabel: 'ગુજરાતી' },
  { value: 'Persian',              nativeLabel: 'فارسی' },
  { value: 'Polish',               nativeLabel: 'Polski' },
  { value: 'Ukrainian',            nativeLabel: 'Українська' },
  { value: 'Romanian',             nativeLabel: 'Română' },
  { value: 'Greek',                nativeLabel: 'Ελληνικά' },
  { value: 'Czech',                nativeLabel: 'Čeština' },
  { value: 'Swedish',              nativeLabel: 'Svenska' },
  { value: 'Hungarian',            nativeLabel: 'Magyar' },
  { value: 'Hebrew',               nativeLabel: 'עברית' },
  { value: 'Malay',                nativeLabel: 'Bahasa Melayu' },
  { value: 'Swahili',              nativeLabel: 'Kiswahili' },
  { value: 'Filipino',             nativeLabel: 'Filipino' },
  { value: 'Nepali',               nativeLabel: 'नेपाली' },
  { value: 'Punjabi',              nativeLabel: 'ਪੰਜਾਬੀ' },
  { value: 'Burmese',              nativeLabel: 'မြန်မာ' },
  { value: 'Khmer',                nativeLabel: 'ខ្មែរ' },
  { value: 'Kannada',              nativeLabel: 'ಕನ್ನಡ' },
  { value: 'Malayalam',            nativeLabel: 'മലയാളം' },
  { value: 'Amharic',              nativeLabel: 'አማርኛ' },
  { value: 'Uzbek',                nativeLabel: 'Oʻzbek' },
  { value: 'Kazakh',               nativeLabel: 'Қазақ' },
  { value: 'Azerbaijani',          nativeLabel: 'Azərbaycanca' },
  { value: 'Serbian',              nativeLabel: 'Српски' },
  { value: 'Croatian',             nativeLabel: 'Hrvatski' },
  { value: 'Bulgarian',            nativeLabel: 'Български' },
  { value: 'Danish',               nativeLabel: 'Dansk' },
  { value: 'Norwegian',            nativeLabel: 'Norsk' },
  { value: 'Finnish',              nativeLabel: 'Suomi' },
  { value: 'Slovak',               nativeLabel: 'Slovenčina' },
  { value: 'Lithuanian',           nativeLabel: 'Lietuvių' },
  { value: 'Catalan',              nativeLabel: 'Català' },
  { value: 'Latvian',              nativeLabel: 'Latviešu' },
  { value: 'Estonian',             nativeLabel: 'Eesti' },
  { value: 'Slovenian',            nativeLabel: 'Slovenščina' },
  { value: 'Bosnian',              nativeLabel: 'Bosanski' },
  { value: 'Albanian',             nativeLabel: 'Shqip' },
  { value: 'Mongolian',            nativeLabel: 'Монгол' },
  { value: 'Irish',                nativeLabel: 'Gaeilge' },
  { value: 'Welsh',                nativeLabel: 'Cymraeg' },
  { value: 'Zulu',                 nativeLabel: 'isiZulu' },
];
        ...
        <div>
          ...
          <div
            ...
            style={{
              ...
              border: '2px solid var(--summary-panel-border)',
